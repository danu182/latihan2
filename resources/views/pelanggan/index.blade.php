...
<div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tables Pelanggan</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="{{ route('pelanggan.create') }}" class="btn btn-success btn-icon-split">
                                        ...
                                        <span class="text">Add Pelanggan</span>
                                    </a>
                                    ...
                                    <thead>
                                        ...
                                        <tr> 
                                            ...
                                            <td>
                                                ...
                                                <form class="btn btn-warning=" action="{{ route('pelanggan.destroy', $item->id) }}" method="POST">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
